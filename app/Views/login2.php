                        ...
                        <div class="login-wrap p-4 p-lg-5">
                            ...
                            <form action="/login/auth" method="post">
                                <div class="form-group mb-3">
                                    <label class="label" for="InputForEmail">Username</label>
                                    <input type="email" name="email" class="form-control" placeholder="Username" id="InputForEmail" value="<?= set_value('email') ?>" required>
                                </div>
                                <div class="form-group mb-3">
